...
function onEachFeature(feature, layer) {
  let popupContent = `
    <p>Tipe geometri: ${
      feature.geometry ? feature.geometry.type : feature.type
    }</p>
  `;
...
const dicodingLayer = L.geoJSON(dicoding, { onEachFeature });
dicodingLayer.addTo(myMap);

const landmarkLayer = L.geoJSON(landmark, { onEachFeature });
landmarkLayer.addTo(myMap);

const trainStopsLayer = L.geoJSON(trainStops, { onEachFeature });
...
// Untuk grouping dan auto zoom in
